...
<head>    
    ...
    <link href="menu/frame1/res/menu/menu.css" rel="stylesheet" type="text/css" />
    <script src="menu/frame1/res/menu/menu.js" type="text/javascript"></script>
    <script src="menu/frame1/res/menutip.js" type="text/javascript"></script>
    <link href="menu/frame1/res/tabs.css" rel="stylesheet" type="text/css" />
    <link href="menu/frame1/res/frame.css" rel="stylesheet" type="text/css" />
    <link href="menu/frame1/res/index.css" rel="stylesheet" type="text/css" />
</head>
<body>
    
<div class="navbar">
    <div class="navbar-header">
        <div class="navbar-brand">myFirstProject</div>
        <div class="navbar-brand navbar-brand-compact">杨</div>
    </div>
    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
            <a class="dropdown-toggle userinfo">
                <img class="user-img" src="menu/frame1/res/images/user1.jpg" />个人资料<i class="fa fa-angle-down"></i>
            </a>
...
<div class="container">
    ...
    <div class="main">
        <div id="mainTabs" class="mini-tabs main-tabs" activeIndex="0" style="height:100%;" plain="false"
            ...
            <div name="index" class="heart" iconCls="fa-android" title="主页">
               <div id="layout1" class="mini-layout" style="width:100%;height:100%;">
                   <div title="1" region="north" height="80" >
                      MyFirstProject
                   </div>
                   <div title="2" region="south" showSplit="false" showHeader="true" height="80"  >
                                                
                   </div>
                   <div title="3" region="west" width="200" >
                    3
                   </div>
                   <div title="4" region="east"  showCloseButton="true" >
                     4
                   </div>
                   <div title="5" region="center" >
                     5
                   </div>
               </div>
            </div>
